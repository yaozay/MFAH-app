...
export default function Checkout() {
  ...
  const shippingOptions = {
    ...
    overnight: { label: "Overnight (1 day)", price: 19.99 },
  };
    ...
    <div className="min-h-screen bg-neutral-100 p-6">
      <div className="max-w-3xl mx-auto space-y-10">
        <div className="bg-white p-6 rounded-xl border border-neutral-200 shadow-sm space-y-4">
          ...
          {[
            ...
            <div key={field}>
              ...
              />
              {errors[field] && <p className="text-rose-500 text-sm">{errors[field]}</p>}
            </div>
          ))}
        </div>
        ...
        >
          ...
          <div>
            ...
            <input
              ...
              className="w-full border border-neutral-300 rounded px-3 py-2"
            />
            {errors.cardName && <p className="text-rose-500 text-sm">{errors.cardName}</p>}
          </div>
          ...
          <div>
            ...
            <input
              ...
              className="w-full border border-neutral-300 rounded px-3 py-2"
            />
            {errors.cardNumber && <p className="text-rose-500 text-sm">{errors.cardNumber}</p>}
          </div>
          ...
          <div className="flex gap-3">
            <div className="flex-1">
              ...
              <input
                ...
                className="w-full border border-neutral-300 rounded px-3 py-2"
              />
              {errors.expMonth && <p className="text-rose-500 text-sm">{errors.expMonth}</p>}
            </div>
            <div className="flex-1">
            ...
            <div className="w-24">
              ...
              <input
                ...
                className="w-full border border-neutral-300 rounded px-3 py-2"
              />
              {errors.cvv && <p className="text-rose-500 text-sm">{errors.cvv}</p>}
            </div>
          </div>
          ...
          <button
            type="submit"
            disabled={processing}
            className={`w-full mt-2 py-3 rounded-lg text-lg font-semibold transition ${processing ? "bg-neutral-300 text-neutral-600" : "bg-black text-white hover:bg-neutral-800"
              }`}
          >
        ...
        <div className="bg-white p-6 rounded-xl border border-neutral-200 shadow-sm text-lg space-y-2">
          ...
          <p className="font-bold text-2xl pt-2">Total: ${finalTotal.toFixed(2)}</p>
        </div>
      </div>
    </div>
  );
