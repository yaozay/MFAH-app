...
export default function DashboardAdmin() {
 ...
 useEffect(() => {
  ...
  // ---- Client-side filtered rows for Employee Search ----
...
//Toggle Active Users
  const toggleActive = async (userId, currentActive) => {
    ...
    try {
      ...
      {/*update employee rows locally so UI changes immediately */}
      setData((prev) => ({
        ...prev,
      ...
      {/* ADDED: update employee rows locally so UI changes immediately*/}
    } catch (e) {
